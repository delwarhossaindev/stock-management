...
<body>
    ...
    <table class="info-table">
        <tr>
            <td>{{ __('Invoice No') }}: {{ $sale->invoice_no }}</td>
            <td style="text-align:right">{{ __('Date') }}: {{ $sale->sale_date->format('d/m/Y') }}</td>
        </tr>
        <tr>
            <td>{{ __('Customer') }}: {{ $sale->customer->name ?? $sale->customer_name ?? __('Walk-in Customer') }}</td>
            <td></td>
        </tr>
    </table>
